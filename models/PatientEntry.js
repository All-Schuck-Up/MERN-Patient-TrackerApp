...
async function createPatientEntry() {
  //async function to create mock-up patient entries
    ...
    form: [
      {
        ...
        symptom3: 'no',
        symptom4: 'yes',
        additionalNote: 'feeling a bit sick',
        media: 'None',
      },
    ],
    ...
    form: [
      {
        ...
        symptom3: 'yes',
        symptom4: 'no',
        additionalNote: 'feeling very sick',
        media: 'None',
      },
    ],
    ...
    form: [
      {
        ...
        symptom3: 'no',
        symptom4: 'no',
        additionalNote: 'feeling much better, thank you doctor',
        media: 'None',
      },
    ],
