...
export const LoginPatient = ({ loginPatient, isAuthenticated }) => {
  ...
  if (isAuthenticated) {
    return <Redirect to='/patient/:_id' />;
  }
...
export default connect(mapStateToProps, { loginPatient })(LoginPatient);
