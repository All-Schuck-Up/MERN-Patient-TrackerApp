        ...
        <div>
          <form className='symptomEntry' onSubmit={this.onSubmit}>
            ...
            <div className='form-group'>
              <div>
                {' '}
                <label>Symptome 1 Question </label>
                <input
                  class='spaceInput'
                  type='radio'
                  value='yes'
            ...
            <div className='form-group'>
              <div>
                {' '}
                <label>Symptome 2 Question </label>
            ...
            <div className='form-group'>
              <div>
                {' '}
                <label>Symptome 3 Question </label>
                <label>
                  <input
                    class='spaceInput'
                    type='radio'
            ...
            <div className='formm-group'>
              <div>
                {' '}
                <label>Symptome 4 Question </label>
                <label>
                  <input
                    class='spaceInput'
                    type='radio'
            ...
            <div className='form-group'>
              ...
              <input
                type='submit'
                value='Mark entry as immediate attention'
