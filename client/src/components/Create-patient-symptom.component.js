...
export default class createSympotom extends Component {
  ...
  onFileUpload(e) {
    ...
    patientMedia.append('myFile', this.state.media, this.state.media.name);
    //file upload info
            ...
            <Card body>
              ...
              >
                ...
                <div className='form-group'>
                  <div>
                    {' '}
                    <label class='spaceInput'>Trouble breathing ? </label>
                    {'      '}
                ...
                <div className='form-group'>
                  ...
                  <button
                    ...
                    onClick={() => this.setState({ attention: true })}
                  >
